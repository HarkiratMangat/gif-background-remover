...
```python
    'dark_bg': dict(
        ...
        what='105 assets on FLAT OPAQUE NON-WHITE backgrounds -- 53 dark (<80 luminance), 55 saturated '
             '(chroma >=60), 65 animated. 119 were supplied; 2 byte-identical duplicates, 6 with no keyable '
             'background and 6 whose background CHANGES COLOUR mid-animation were removed first. Supplied 2026-08-20 to close the one gap the '
